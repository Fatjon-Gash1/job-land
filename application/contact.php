...
<body>
  ...
  <div class="Cform-div">
    <form class="contact-form" action="submit_form.php" method="post">
      ...
      <input class="inputCT" placeholder="Enter your name" type="text" id="name" name="name" required><br>

      <label class="emailCT" for="email">Email:</label><br>
      <input class="inputEM" placeholder="name@example.com" type="email" id="email" name="email" required><br>

      <label class="messageCT" for="message">Message:</label><br>
      <textarea class="inputMS" placeholder="Enter your message" id="message" name="message" rows="4" required></textarea><br>
